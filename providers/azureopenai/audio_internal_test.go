...
// file-extension mapping used when building the multipart STT upload
// filename. Mirrors providers/openai/audio_internal_test.go because the
// helpers share a shape and a fallback.
